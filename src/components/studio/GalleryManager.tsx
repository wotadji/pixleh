    ...
    <div className="-m-8 flex h-screen flex-col">
      ...
      <div className="sticky top-0 z-30 flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 bg-white px-6 py-3 shrink-0">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {/* Fichiers RAW/originaux — lien vers la page dédiée (demande d'Adriel le 18/09/2026 :
              "tu vois pas qu'il faut une page ?", plus d'organisation en dossiers possible dans
              une modale). Toujours visible même pendant un upload de photos (flux totalement
              indépendant, voir /dashboard/galleries/[id]/files). */}
          <Link
            href={`/dashboard/galleries/${gallery.id}/files`}
            title={t("gm.rawFiles")}
            className="btn-secondary flex items-center gap-1.5 text-sm"
          >
            <IconFiles />
